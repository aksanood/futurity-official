...
const Navbar = () => {
  ...
  return <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-futurity-blue py-4'}`}>
      <div className="container-wide flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img src={scrolled ? "/Futurity_Logo_Light_Background.svg" : "/Futurity_Logo_Dark_Background.svg"} alt="Futurity Logo" className="h-8 w-auto mr-2" style={{
