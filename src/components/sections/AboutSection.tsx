    ...
    <section className="section bg-white relative overflow-hidden">
      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-on-scroll stagger-delay-1 space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 bg-futurity-blue/10 rounded-full px-4 py-2 text-futurity-blue font-medium text-sm">
                <div className="w-2 h-2 bg-futurity-orange rounded-full"></div>
                About Futurity
              </div>
              
              <h2 className="text-4xl md:text-5xl font-bold text-futurity-blue">
